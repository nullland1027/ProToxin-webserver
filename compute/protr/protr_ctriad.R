...
for (i in seq_along(test_fasta)) {
  seq <- test_fasta[[i]]
  feature_list <- append(feature_list, list(extractCTriad(seq)))
...
# 筛选
selected_cols <- df[, c("VS362", "VS261", "VS131", "VS314", "VS552", "VS236", "VS215", "VS136", "VS722", "VS652", "VS216", "VS327")]

# 将数据框写入CSV文件
result_filename <- "neg_ctriad_12_all.csv"
